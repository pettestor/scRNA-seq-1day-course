...
Here we will use the Seurat funciton *FindAllMarkers* to identify marker genes for each cluster. We will then visualize the top 10 marker genes for each cluster using a heatmap.
...
In this section, we perform pathway enrichment analysis using marker genes identified in **Section 6.2**. The **clusterProfiler** package allows us to investigate biological pathways associated with clusters or conditions of interest.
