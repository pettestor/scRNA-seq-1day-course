...
#### 6.3.1 Automated annotation using singleR
...
#### 6.3.2 Automated annotation using Seurats labeltransfer
...
### 7.1 Pathway Analysis with clusterProfiler
...
### 7.2 Identifying number of clusters
...
table(da_integrated$Phase, da_integrated$orig.ident)                 # Count cells in each phase
DimPlot(da_integrated, group.by = "Phase", reduction = "umap_harmony") # Plot cells grouped by their predicted cell cycle phase
```
