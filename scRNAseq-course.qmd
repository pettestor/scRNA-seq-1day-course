...
# 8. Interacting with the seurat object

### 8.1 Accessing and Manipulating Data
...
# Accessing the expression values of a specific gene for all cells
# raw data
gene_expression <- da_integrated[["RNA"]]$counts["TH", ]
# normalised data
gene_expression <- da_integrated[["RNA"]]$data["TH", ]

```

# 9. Extras

### 9.1 Pathway Analysis with clusterProfiler

In this section, we perform pathway enrichment analysis using marker
genes identified in **Section 7.2**. The **clusterProfiler** package
...
### 9.2 Identifying number of clusters
